...
* $X_{0}$ une variables auxiliaire connue pour les répondants et non-répondants ; 
* $X_{1}$ une variables sociodémographique connue uniquement pour les répondants ; 
* Y la variable d’intérêt, connue uniquement pour les répondants : Y est expliquée par $X_{0}$ et $X_{1}$, mais aussi par U  
...
## La representation conceptuelle du processus de l'enquête
![Add some text here](schemat.png)

Comme nous 
## La formulation de l'indicateur d'intérêt
>>>>>>> 60b46cf6d7236e09e3d25c968010699c92820287
